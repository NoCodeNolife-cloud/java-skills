...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //通过"80.0"字符串创建数值为80.0的Float对象  Float objFloat = new Float("80.0");
        ...
        int result = objFloat2.compareTo(objFloat2);  // result = -1，表示objFloat小于objFloat2  System.out.println(result);
        // 4.字符串转换为基本数据类型
